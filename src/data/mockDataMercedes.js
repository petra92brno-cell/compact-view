...
// Cycles through all 10 local images — one per post, repeating after 10
const MB_IMAGES = [
  imageMercedesAMGGT, imageMercedesSClass, imageMercedesGLE,
  imageMercedesGWagon, imageMercedesEClass, imageMercedesEQS,
  imageMercedesAClass, imageMercedesSilver, imageMercedesRed, imageMercedesWhite,
];
let _mbIdx = 0;
const mbImg = () => MB_IMAGES[_mbIdx++ % MB_IMAGES.length];
...
export const mercedesScheduledPosts = [
  // Monday 08:00 – EQ Campaign, Germany FB
  {
    ...
    comments: { count: 3 },
    media: { type: 'image', src: mbImg(), alt: 'Mercedes-Benz EQS Electric' },
    status: 'scheduled',
    campaignId: 101,
  },
  ...
  // Monday 14:00 – EQ Campaign, EQ Page FB
  {
    ...
    media: { type: 'image', src: mbImg(), alt: 'Mercedes-Benz EQS Charging' },
    status: 'scheduled',
    campaignId: 101,
  },
  // Tuesday 09:00 – AMG Campaign, AMG FB
  {
    ...
    comments: { count: 5 },
    media: { type: 'image', src: mbImg(), alt: 'Mercedes-AMG GT' },
    status: 'scheduled',
    campaignId: 102,
  },
  // Tuesday 12:00 – AMG Campaign, AMG IG
  {
    ...
    media: { type: 'image', src: mbImg(), alt: 'Mercedes-AMG GT Performance' },
    status: 'scheduled',
    campaignId: 102,
  },
  // Tuesday 18:00 – CZ Market, Czech Republic FB
  {
    ...
    media: { type: 'image', src: mbImg(), alt: 'Mercedes-Benz GLE Test Drive' },
    status: 'scheduled',
    campaignId: 103,
  },
  // Wednesday 08:30 – Always On, Germany IG
  {
    ...
    media: { type: 'image', src: mbImg(), alt: 'Mercedes-Benz S-Class' },
    status: 'scheduled',
    campaignId: 105,
  },
  // Wednesday 15:00 – Maybach, Germany FB
  {
    ...
    comments: { count: 2 },
    media: { type: 'image', src: mbImg(), alt: 'Mercedes-Maybach S-Class' },
    status: 'scheduled',
    campaignId: 104,
  },
  // Thursday 10:00 – France FB
  {
    ...
    media: { type: 'image', src: mbImg(), alt: 'Mercedes-Benz CLA Coupé' },
    status: 'scheduled',
    campaignId: 106,
  },
  // Thursday 14:30 – USA IG
  {
    ...
    media: { type: 'image', src: mbImg(), alt: 'Mercedes-Benz GLE Road Trip' },
    status: 'scheduled',
    campaignId: 107,
  },
  // Friday 09:00 – Germany LI
  {
    ...
    media: { type: 'image', src: mbImg(), alt: 'Mercedes-Benz EQ Sustainability' },
    status: 'scheduled',
    campaignId: 105,
  },
  // Friday 16:00 – Czech Republic IG
  {
    ...
    media: { type: 'image', src: mbImg(), alt: 'Mercedes-Benz A-Class Weekend' },
    status: 'scheduled',
    campaignId: 105,
  },
  // Saturday 11:00 – USA FB
  {
    ...
    media: { type: 'image', src: mbImg(), alt: 'Mercedes-Benz EQS SUV' },
    status: 'scheduled',
    campaignId: 101,
  },
  // Saturday 15:00 – G-Wagon Germany IG
  {
    ...
    media: { type: 'image', src: mbImg(), alt: 'Mercedes-Benz G-Class G63 AMG' },
    status: 'scheduled',
    campaignId: 105,
  },
];
...
export const mercesDraftPosts = [
  // Sunday draft – Experience Center Germany FB
  {
    ...
    media: { type: 'image', src: mbImg(), alt: 'Mercedes-Benz E-Class showroom' },
    status: 'draft',
    campaignId: 105,
  },
  // Monday draft – AMG IG
  {
    ...
    media: { type: 'image', src: mbImg(), alt: 'Mercedes-AMG GT Track' },
    status: 'draft',
    campaignId: 102,
  },
  // Tuesday draft – Czech Republic FB
  {
    ...
    media: { type: 'image', src: mbImg(), alt: 'Mercedes-Benz GLC Czech Republic' },
    status: 'draft',
    campaignId: 103,
  },
  // Wednesday draft – France IG – Maybach
  {
    ...
    media: { type: 'image', src: mbImg(), alt: 'Mercedes-Maybach S-Class France' },
    status: 'draft',
    campaignId: 104,
  },
  // Wednesday draft – Germany YT – AMG Factory
  {
    ...
    media: { type: 'image', src: mbImg(), alt: 'Mercedes-AMG Affalterbach Factory YouTube' },
    status: 'draft',
    campaignId: 102,
  },
  // Thursday draft – USA TW – Road Trip
  {
    ...
    media: { type: 'image', src: mbImg(), alt: 'Mercedes-Benz GLE Road Trip USA' },
    status: 'draft',
    campaignId: 107,
  },
  // Friday draft – EQ Page IG – Charging
  {
    ...
    media: { type: 'image', src: mbImg(), alt: 'Mercedes-Benz EQS Charging Technology' },
    status: 'draft',
    campaignId: 101,
  },
  // Saturday draft – Germany IG – S-Class interior
  {
    ...
    media: { type: 'image', src: mbImg(), alt: 'Mercedes-Benz S-Class Interior' },
    status: 'draft',
    campaignId: 105,
  },
  // Saturday draft – G-Wagon USA FB
  {
    ...
    media: { type: 'image', src: mbImg(), alt: 'Mercedes-Benz G-Wagon USA' },
    status: 'draft',
    campaignId: 105,
  },
  // Sunday draft – A-Class CZ IG
  {
    ...
    media: { type: 'image', src: mbImg(), alt: 'Mercedes-Benz A-Class Czech Republic' },
    status: 'draft',
    campaignId: 105,
  },
];
